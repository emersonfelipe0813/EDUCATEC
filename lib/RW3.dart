...
class RW3 extends StatefulWidget {
  final int score;

  RW3({required this.score});

  @override
  _RW3State createState() => _RW3State();
}

class _RW3State extends State<RW3> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'A Internet das Coisas (IoT) é um tipo de protocolo de rede',
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW4(score: widget.score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW4(score: score)),
                      );
                    });
                  }
                },
