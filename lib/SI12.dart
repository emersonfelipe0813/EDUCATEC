...
import 'SI2.dart'; // substitua pelo caminho correto do arquivo LOG2

class SI12 extends StatelessWidget {
  final int score; // recebe a variável newscore da tela LOG11

  SI12({required this.score}); // construtor que recebe a variável newscore
              ...
              children: <Widget>[
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => SI2()),
                    );
                  },
                  icon: Icon(
                    Icons.refresh,
