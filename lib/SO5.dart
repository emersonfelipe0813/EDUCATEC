...
class SO5 extends StatefulWidget {
  final int score;

  SO5({required this.score});

  @override
  _SO5State createState() => _SO5State();
}

class _SO5State extends State<SO5> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'A multitarefa permite que vários programas sejam executados simultaneamente em um computador.',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SO6(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SO6(score: widget.score)),
                      );
                    });
                  }
                },
