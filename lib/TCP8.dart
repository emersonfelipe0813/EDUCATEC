...
class TCP8 extends StatefulWidget {
  final int score;

  TCP8({required this.score});

  @override
  _TCP8State createState() => _TCP8State();
}

class _TCP8State extends State<TCP8> {
      ...
      appBar: AppBar(
        ...
        title: RichText(
          text: TextSpan(
            ...
            children: <TextSpan>[
              TextSpan(text: 'ECD', style: TextStyle(color: Colors.black)),
            ],
          ),
        ),
      ),
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'O protocolo DHCP serve para atribuir dinamicamente endereços IP a dispositivos na rede.',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => TCP9(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => TCP9(score: widget.score)),
                      );
                    });
                  }
                },
