...
class RW4 extends StatefulWidget {
  final int score;

  RW4({required this.score});

  @override
  _RW4State createState() => _RW4State();
}

class _RW4State extends State<RW4> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'A virtualização de rede é um tipo de arquitetura de rede.',
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW5(score: widget.score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW5(score: score)),
                      );
                    });
                  }
                },
