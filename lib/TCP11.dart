...
class TCP11 extends StatefulWidget {
  final int score;

  TCP11({required this.score});

  @override
  _TCP11State createState() => _TCP11State();
}

class _TCP11State extends State<TCP11> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'O protocolo POP3 é utilizado para transferir arquivos entre computadores.',
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => TCP12(score: widget.score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => TCP12(score: score)),
                      );
                    });
                  }
                },
