...
class SO6 extends StatefulWidget {
  final int score;

  SO6({required this.score});

  @override
  _SO6State createState() => _SO6State();
}

class _SO6State extends State<SO6> {
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SO7(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SO7(score: widget.score)),
                      );
                    });
                  }
                },
