...
class LOG10 extends StatefulWidget {
  final int score;

  LOG10({required this.score});

  @override
  _LOG10State createState() => _LOG10State();
}

class _LOG10State extends State<LOG10> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'O barramento de dados da placa-mãe define a velocidade de comunicação entre o processador e a memória RAM.',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LOG11(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LOG11(score: widget.score)),
                      );
                    });
                  }
                },
