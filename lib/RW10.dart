...
class RW10 extends StatefulWidget {
  final int score;

  RW10({required this.score});

  @override
  _RW10State createState() => _RW10State();
}

class _RW10State extends State<RW10> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  ' Edge computing é uma tecnologia que processa dados no núcleo da rede.',
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW11(score: widget.score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW11(score: score)),
                      );
                    });
                  }
                },
