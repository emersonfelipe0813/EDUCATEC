...
class TCP10 extends StatefulWidget {
  final int score;

  TCP10({required this.score});

  @override
  _TCP10State createState() => _TCP10State();
}

class _TCP10State extends State<TCP10> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'O protocolo ICMP é usado para enviar mensagens de erro e controle na rede.',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => TCP11(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => TCP11(score: widget.score)),
                      );
                    });
                  }
                },
