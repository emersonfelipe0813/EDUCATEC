...
import 'TCP2.dart'; // substitua pelo caminho correto do arquivo LOG2

class TCP12 extends StatelessWidget {
  final int score; // recebe a variável newscore da tela LOG11

  TCP12({required this.score}); // construtor que recebe a variável newscore
              ...
              children: <Widget>[
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => TCP2()),
                    );
                  },
                  icon: Icon(
                    Icons.refresh,
