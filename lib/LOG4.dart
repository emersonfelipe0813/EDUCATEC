...
class LOG4 extends StatefulWidget {
  ...
  LOG4({required this.score});

  @override
  _LOG4State createState() => _LOG4State();
}
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'A pasta térmica deve ser aplicada entre o processador e o dissipador de calor para melhorar a condução de calor.',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LOG5(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LOG5(score: widget.score)),
                      );
                    });
                  }
                },
