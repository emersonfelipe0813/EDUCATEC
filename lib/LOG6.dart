...
class LOG6 extends StatefulWidget {
  final int score;

  LOG6({required this.score});

  @override
  _LOG6State createState() => _LOG6State();
}

class _LOG6State extends State<LOG6> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'Os cabos SATA são usados para conectar o disco rígido à placa-mãe',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LOG7(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LOG7(score: widget.score)),
                      );
                    });
                  }
                },
