          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'As redes privadas virtuais (VPNs) ajudam a proteger a privacidade e a segurança ao usar redes Wi-Fi públicas.',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SI10(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SI10(score: widget.score)),
                      );
                    });
                  }
                },
