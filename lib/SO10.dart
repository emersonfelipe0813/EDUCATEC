...
class SO10 extends StatefulWidget {
  final int score;

  SO10({required this.score});
  @override
  _SO10State createState() => _SO10State();
}

class _SO10State extends State<SO10> {
      ...
      appBar: AppBar(
        ...
        title: RichText(
          text: TextSpan(
            ...
            children: <TextSpan>[
              TextSpan(text: 'ASO', style: TextStyle(color: Colors.black)),
            ],
          ),
        ),
      ),
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'O sistema operacional não é responsável pelo gerenciamento dos dispositivos de armazenamento do computador.',
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SO11(score: widget.score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SO11(score: score)),
                      );
                    });
                  }
                },
