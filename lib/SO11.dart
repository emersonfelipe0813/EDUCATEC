...
class SO11 extends StatefulWidget {
  final int score;

  SO11({required this.score});
  @override
  _SO11State createState() => _SO11State();
}

class _SO11State extends State<SO11> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'O sistema operacional não fornece recursos de segurança para proteger o computador contra malware.',
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SO12(score: widget.score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SO12(score: score)),
                      );
                    });
                  }
                },
