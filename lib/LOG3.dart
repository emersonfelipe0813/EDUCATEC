...
class LOG3 extends StatefulWidget {
  ...
  LOG3({required this.score});

  @override
  _LOG3State createState() => _LOG3State();
}
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'Um SSD (Solid State Drive) geralmente possui uma vida útil maior e é mais rápido que um HD.',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LOG4(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LOG4(score: widget.score)),
                      );
                    });
                  }
                },
