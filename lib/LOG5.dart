...
class LOG5 extends StatefulWidget {
  final int score;

  LOG5({required this.score});

  @override
  _LOG5State createState() => _LOG5State();
}

class _LOG5State extends State<LOG5> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'Uma fonte de alimentação com potência insuficiente pode causar reinicializações inesperadas do sistema.',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LOG6(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LOG6(score: widget.score)),
                      );
                    });
                  }
                },
