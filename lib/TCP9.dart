...
class TCP9 extends StatefulWidget {
  final int score;

  TCP9({required this.score});

  @override
  _TCP9State createState() => _TCP9State();
}

class _TCP9State extends State<TCP9> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'O protocolo IMAP é utilizado para transferir arquivos entre computadores.',
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => TCP10(score: widget.score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => TCP10(score: score)),
                      );
                    });
                  }
                },
