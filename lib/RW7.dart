...
class RW7 extends StatefulWidget {
  final int score;

  RW7({required this.score});

  @override
  _RW7State createState() => _RW7State();
}

class _RW7State extends State<RW7> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  ' A rede 5G é um tipo de rede sem fio que fornece transmissão de dados de alta velocidade.',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW8(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW8(score: widget.score)),
                      );
                    });
                  }
                },
