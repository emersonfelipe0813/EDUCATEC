...
class SO9 extends StatefulWidget {
  final int score;

  SO9({required this.score});

  @override
  _SO9State createState() => _SO9State();
}

class _SO9State extends State<SO9> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'O sistema operacional fornece uma interface entre o usuário e o hardware do computador.',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SO10(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SO10(score: widget.score)),
                      );
                    });
                  }
                },
