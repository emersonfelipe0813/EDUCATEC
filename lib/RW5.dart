...
class RW5 extends StatefulWidget {
  final int score;

  RW5({required this.score});

  @override
  _RW5State createState() => _RW5State();
}

class _RW5State extends State<RW5> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'Software-Defined Networking (SDN) é uma tecnologia que separa o plano de controle do plano de dados.',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW6(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW6(score: widget.score)),
                      );
                    });
                  }
                },
