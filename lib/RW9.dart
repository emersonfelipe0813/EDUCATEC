...
class RW9 extends StatefulWidget {
  final int score;

  RW9({required this.score});

  @override
  _RW9State createState() => _RW9State();
}

class _RW9State extends State<RW9> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'A Internet dos Corpos (IoB) é um tipo de rede que conecta dispositivos dentro do corpo humano.',
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW10(score: widget.score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW10(score: score)),
                      );
                    });
                  }
                },
