...
import 'lOG2.dart'; // substitua pelo caminho correto do arquivo LOG2

class LOG12 extends StatelessWidget {
  final int score; // recebe a variável newscore da tela LOG11

  LOG12({required this.score}); // construtor que recebe a variável newscore
