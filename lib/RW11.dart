...
class RW11 extends StatefulWidget {
  final int score;

  RW11({required this.score});

  @override
  _RW11State createState() => _RW11State();
}

class _RW11State extends State<RW11> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'A análise de Big Data é usada no gerenciamento de rede para analisar padrões de tráfego de rede.',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW12(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW12(score: widget.score)),
                      );
                    });
                  }
                },
