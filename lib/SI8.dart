          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'Certificados SSL/TLS são usados para criptografar a comunicação entre o navegador e o servidor, protegendo os dados transmitidos.',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SI9(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SI9(score: widget.score)),
                      );
                    });
                  }
                },
