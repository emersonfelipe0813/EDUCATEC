...
class RW6 extends StatefulWidget {
  final int score;

  RW6({required this.score});

  @override
  _RW6State createState() => _RW6State();
}

class _RW6State extends State<RW6> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'Network Functions Virtualization (NFV) é uma tecnologia que virtualiza serviços de rede.',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW7(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW7(score: widget.score)),
                      );
                    });
                  }
                },
