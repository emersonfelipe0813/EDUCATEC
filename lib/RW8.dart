...
class RW8 extends StatefulWidget {
  final int score;

  RW8({required this.score});

  @override
  _RW8State createState() => _RW8State();
}

class _RW8State extends State<RW8> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'A Inteligência Artificial (IA) não é usada em sistemas de segurança de rede.',
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW9(score: widget.score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RW9(score: score)),
                      );
                    });
                  }
                },
