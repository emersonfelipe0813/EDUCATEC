...
class TCP6 extends StatefulWidget {
  final int score;

  TCP6({required this.score});

  @override
  _TCP6State createState() => _TCP6State();
}

class _TCP6State extends State<TCP6> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'O protocolo HTTPS é a versão segura do HTTP, usando criptografia.',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => TCP7(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => TCP7(score: widget.score)),
                      );
                    });
                  }
                },
