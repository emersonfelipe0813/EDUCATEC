...
class LOG9 extends StatefulWidget {
  final int score;

  LOG9({required this.score});

  @override
  _LOG9State createState() => _LOG9State();
}

class _LOG9State extends State<LOG9> {
      ...
      appBar: AppBar(
        ...
        title: RichText(
          text: TextSpan(
            ...
            children: <TextSpan>[
              TextSpan(text: 'MMC', style: TextStyle(color: Colors.black)),
            ],
          ),
        ),
      ),
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'É necessário desconectar todos os cabos antes de remover uma placa de expansão da placa-mãe.',
                  style: TextStyle(fontSize: screenHeight * 0.03),
                ),
              ),
              SizedBox(
                  height: screenHeight *
                      0.05), // Espaço considerável entre o contêiner de texto e o contêiner "Verdadeiro"
              GestureDetector(
                onTap: () {
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LOG10(score: widget.score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LOG10(score: score)),
                      );
                    });
                  }
                },
