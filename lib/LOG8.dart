...
class LOG8 extends StatefulWidget {
  final int score;

  LOG8({required this.score});

  @override
  _LOG8State createState() => _LOG8State();
}

class _LOG8State extends State<LOG8> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'O PCIe é um tipo de slot usado para conectar placas de vídeo na placa-mãe',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LOG9(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LOG9(score: widget.score)),
                      );
                    });
                  }
                },
