          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'Firewalls podem ser configurados para monitorar e filtrar tráfego de rede específico, aumentando a segurança.',
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SI6(score: score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SI6(score: widget.score)),
                      );
                    });
                  }
                },
