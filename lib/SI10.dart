...
class SI10 extends StatefulWidget {
  final int score;

  SI10({required this.score});
  @override
  _SI10State createState() => _SI10State();
}

class _SI10State extends State<SI10> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'É seguro ignorar avisos de certificados de segurança expirados ao acessar websites.',
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SI11(score: widget.score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SI11(score: score)),
                      );
                    });
                  }
                },
