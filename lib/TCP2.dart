...
class TCP2 extends StatefulWidget {
  @override
  _TCP2State createState() => _TCP2State();
}

class _TCP2State extends State<TCP2> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'O protocolo HTTP é usado para transferir arquivos entre computadores.',
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => TCP3(score: score)),
                      );
                    });
                  }
                },
