...
class SI11 extends StatefulWidget {
  final int score;

  SI11({required this.score});
  @override
  _SI11State createState() => _SI11State();
}

class _SI11State extends State<SI11> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'A segurança de um sistema é garantida apenas pela instalação de um software antivírus',
                  ...
                  if (!_falsoButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SI12(score: widget.score)),
                      );
                    });
                  }
                },
                  ...
                  if (!_verdadeiroButtonClicked && !_buttonDisabled) {
                    ...
                    Future.delayed(Duration(seconds: 2), () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SI12(score: score)),
                      );
                    });
                  }
                },
